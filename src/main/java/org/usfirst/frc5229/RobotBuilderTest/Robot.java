...
import org.usfirst.frc5229.RobotBuilderTest.subsystems.*;
...
public class Robot extends TimedRobot {
    ...
    public static ClimbElevator climbElevator;
    public static Claws claws;
    public static ClawTilt clawTilt;
    public static ClawWheels clawWheels;
    ...
    public void robotInit() {
        ...
        claws = new Claws();
        clawTilt = new ClawTilt();
        clawWheels = new ClawWheels();
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.setDefaultOption("Autonomous Cmd", new AutonomousCmd());
